...
export function AppSidebar() {
    ...
    switch (userRole) {
      ...
      case 'gym-owner':
        return [
          ...
          { label: 'Payment Receipts', icon: Receipt, href: "/payment-receipts" },
  ...
  return (
    <Sidebar className="border-r border-gray-700">
      <SidebarContent className="bg-gradient-to-b from-gray-900/80 via-gray-900/50 to-gray-900/80 backdrop-blur-md border-r border-gray-800">
        <SidebarGroup>
              ...
              {navigationItems.map((item, index) => (
                <SidebarMenuItem key={index}>
                  <SidebarMenuButton
                    ...
                    className={`w-full justify-start text-gray-300 hover:text-white hover:bg-blue-600/20 ${

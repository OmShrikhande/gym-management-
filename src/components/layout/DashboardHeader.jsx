...
// import { useGymBranding } from "@/hooks/useGymBranding"; // Removed dynamic branding
...
const DashboardHeader = () => {
  ...
  // Static branding values after removing settings system
  const getAppName = () => 'GymFlow';
  const getAppLogo = () => null;
  const getAppSubtitle = () => 'Fitness Management';
  const getPrimaryColor = () => '#125879ff'; // light futuristic blue
  const getSecondaryColor = () => '#534199ff'; // light futuristic purple
  ...
  return (
    <header className=" backdrop-blur-md border-b border-gray-900 sticky top-0 z-50">

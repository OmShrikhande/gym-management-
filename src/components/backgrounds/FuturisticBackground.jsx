...
/**
 * Futuristic animated background with gradient, particles, waves and geometric shapes
 * - Variant controls color spectrum (users, analytics, reports, settings, attendance, default)

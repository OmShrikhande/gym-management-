...
import { User, Mail, Phone, MapPin, Calendar, Users, Save, X, CreditCard } from 'lucide-react';
...
const MemberForm = ({ member = null, onSave, onCancel, isEditing = false }) => {
  const [formData, setFormData] = useState({
    ...
    // Payment mode: 'online' (default) or 'cash'
    paymentMode: member?.paymentMode || 'online',
    joiningDate: member?.joiningDate || '', // Remove default to today's date
    notes: member?.notes || ''
  });
  ...
  const validateForm = () => {
    const required = ['name', 'email', 'phone', 'membershipType', 'joiningDate', 'paymentMode']; // Add joiningDate as required and paymentMode

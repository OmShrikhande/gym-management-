...
import { verifyMembership, markAttendance, getGymAttendanceStats, markTrainerAttendance, getAllTrainersAttendanceStats } from '../controllers/memberController.js';
...
// Trainer attendance: mark own or by gym owner (requires authentication)
router.post('/trainer/mark', protect, markTrainerAttendance);

// Trainer-wide attendance stats for a gym (requires authentication)
router.get('/trainers/stats', protect, getAllTrainersAttendanceStats);
